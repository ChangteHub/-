...
public class AdminController {
    ...
    public Result<Map<String, Object>> getDashboard() {
        ...
        stats.put("activeUsers", userRepository.selectCount(activeUserWrapper));
        
        // 商品统计
        stats.put("totalProducts", productRepository.selectCount(null));
        LambdaQueryWrapper<Product> onSaleWrapper = new LambdaQueryWrapper<>();
        onSaleWrapper.eq(Product::getStatus, 0);
        stats.put("onSaleProducts", productRepository.selectCount(onSaleWrapper));
        LambdaQueryWrapper<Product> soldWrapper = new LambdaQueryWrapper<>();
        soldWrapper.eq(Product::getStatus, 1);
        stats.put("soldProducts", productRepository.selectCount(soldWrapper));
        
        // 认证统计
        stats.put("totalVerifications", verificationRepository.selectCount(null));
        LambdaQueryWrapper<Verification> pendingWrapper = new LambdaQueryWrapper<>();
        pendingWrapper.eq(Verification::getStatus, 0);
        stats.put("pendingVerifications", verificationRepository.selectCount(pendingWrapper));
        
        // 分类统计
        stats.put("totalCategories", categoryRepository.selectCount(null));
        ...
        stats.put("todayNewUsers", userRepository.selectCount(todayUserWrapper));
        ...
        stats.put("todayNewProducts", productRepository.selectCount(todayProductWrapper));
    ...
    public Result<PageResult<Map<String, Object>>> getUserList(
        ...
        for (Map<String, Object> row : productRepository.selectMaps(countWrapper)) {
    ...
    public Result<Map<String, Object>> getUserDetail(@PathVariable Long id) {
        ...
        return Result.success(convertToUserAdminVO(user, productRepository.selectCount(productWrapper)));
    }
    ...
    public Result<PageResult<Map<String, Object>>> getProductList(
        ...
        Map<Long, Category> categoryMap = categoryIds.isEmpty()
                ? Map.of()
                : categoryRepository.selectBatchIds(categoryIds).stream()
    ...
    public Result<Void> deleteProduct(@PathVariable Long id) {
        ...
        productImageRepository.delete(imgWrapper);
    ...
    public Result<PageResult<Map<String, Object>>> getVerificationList(
        ...
        Page<Verification> result = verificationRepository.selectPage(page, wrapper);
    ...
    public Result<Void> reviewVerification(@PathVariable Long id, @Valid @RequestBody ReviewVerificationRequest request) {
        Verification verification = verificationRepository.selectById(id);
        ...
        verificationRepository.updateById(verification);
    ...
    public Result<List<Category>> getCategoryList() {
        ...
        return Result.success(categoryRepository.selectList(wrapper));
    }
